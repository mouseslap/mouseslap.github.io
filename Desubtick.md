...
**CJ with w-release**
```
alias +cj "+jump_;+duck_;checkw"
alias -cj "-jump_;-duck_"
bind <key> +cj
```
...
**CJ with w-release**
```
alias tick1 "+jump_;-jump_;+duck_;checkw;bind mwheelup tick2"
alias tick2 ";-duck_"
bind mwheelup +tick1
```
...
**Normal jump with w-release**
```
alias tick1 "+jump_;-jump_;checkw"
bind mwheelup tick1
```
## Null
